...
function setup() {
	paint = createCanvas(850-250,800);
	...
	window.onresize = function(){
		document.getElementsByTagName('canvas')[0].style.width = 850-250;
		document.getElementsByTagName('canvas')[0].style.height = 800;
	}
}

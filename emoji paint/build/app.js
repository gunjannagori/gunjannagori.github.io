...
/***/ function(module, exports, __webpack_require__) {
	...
	defaultInput = ':books: :evergreen_tree: :hibiscus: :cherry_blossom:';
	...
	module.exports = UI = {
	  ...
	  setup: function() {
	    createDiv('canvas');
	    createButton('download').mouseClicked(function() {
	      return saveCanvas('paint', 'png');
	    });


	    createButton('erase').mouseClicked(function() {
	    ...
	    createSpan('symmetry ');
	    createSlider(1, 128, UI.size).input(function() {
